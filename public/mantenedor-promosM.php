...
<body>
    ...
    <div class="title-mantenedor">
        ...
        <a class="btn-large waves-effect waves-light red modal-trigger" href="#modal_mantenedor_promo_chef">A gusto del chef</a>
        <a class="btn-large waves-effect waves-light red modal-trigger" href="#modal_mantenedor_promo_cliente">Arma tu promo</a>
    </div>
