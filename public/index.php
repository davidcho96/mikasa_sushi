...
<body>
        ...
        <div class="row">
            ...
            <div class="col s12 m6 l3 wow slideInRight" data-wow-delay="0.3s">
                <div class="icon-block">
                    ...
                    <p class="light servicios-p-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quis tempora quae culpa, impedit voluptas reprehenderit
                        earum quaerat tenetur magni, repudiandae id officia deleniti cum nostrum minus architecto corrupti,
                        quibusdam saepe?
                    </p>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="parallax-text col s12 white-text">
                    <p class="lighten-2 header">Registrate y hazte parte de Mikasa</p>
                ...
                <div>
                    <a class="btn black accent-4 btn-large waves-effect waves pulse">Registrarse</a>
                </div>
            </div>
        </div>
        <div class="parallax">
    ...
    <!-- Carta -->
    <div id="carta" class="section scrollspy">
        <div class="row carta-index wow slideInLeft">
            <div class="col s12 m12 l4">
                <div class="card">
                    ...
                    <div class="card-reveal">
                        <span class="card-title grey-text text-darken-4">Promo 5
                            <i class="material-icons right">close</i>
                        </span>
                        <p>Here is some more information about this product that is only revealed once clicked on.</p>
                    </div>
